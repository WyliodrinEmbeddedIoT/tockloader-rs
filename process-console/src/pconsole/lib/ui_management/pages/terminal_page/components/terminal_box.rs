...
use crate::pconsole::lib::ui_management::pages::Component;
use bytes::Bytes;
...
use crate::pconsole::lib::state_store::{Action, AppData, State};
use crate::pconsole::lib::ui_management::components::ComponentRender;
use crate::pconsole::lib::ui_management::pages::terminal_page::section::SectionActivation;
...
impl Component for TerminalBox {
    fn new(
        state: &crate::pconsole::lib::state_store::State,
    ...
    fn update_with_state(self, state: &crate::pconsole::lib::state_store::State) -> Self
    where
        Self: Sized,
    {
        Self {

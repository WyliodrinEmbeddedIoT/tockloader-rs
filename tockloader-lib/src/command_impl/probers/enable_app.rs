...
use crate::CommandEnableApp;

const ENABLED_OFFSET: u64 = 8;
const CHECKSUM_OFFSET: u64 = 12;

#[async_trait]
impl CommandEnableApp for ProbeRSConnection {
    async fn enable_app(
        &mut self,
        ...
        'outer: loop {
            ...
            // make "Enable all" a part of this vector
            installed_apps.push(AppData {
                name: "Enable all".to_string(),
            ...
            match app_name {
                ...
                None => loop {
                    app = inquire::Select::new(
                        "Which app do you want to enable?",
